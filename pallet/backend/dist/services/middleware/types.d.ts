...
export type IntentType = 'file_operation' | 'terminal_command' | 'external_service' | 'project_scaffold' | 'code_generation' | 'migration' | 'seo_optimization' | 'deployment';
...
export type Intent = FileOperationIntent | TerminalCommandIntent | CodeGenerationIntent;
